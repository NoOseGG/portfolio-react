      ...
      <ul className={styles.menu}>
        <li className={styles.menu__item}>
          <a className={styles.menu__link} href="#">
            ...
            <span className={styles.menu__item__name}>Instagram</span>
          </a>
        </li>
        <li className={styles.menu__item}>
          <a className={styles.menu__link} href="#">
            ...
            <span className={styles.menu__item__name}>LinkedIn</span>
          </a>
        </li>
        <li className={styles.menu__item}>
          <a className={styles.menu__link} href="#">
            ...
            <span className={styles.menu__item__name}>GitHub</span>
          </a>
        </li>
      </ul>
    </menu>
