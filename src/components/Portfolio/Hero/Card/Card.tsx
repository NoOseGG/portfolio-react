    ...
    <div className={styles.card}>
      ...
      <ul className={styles.card__requisites__list}>
        ...
        <li className={styles.card__requisites__item}>
          ...
          www.yurysvirydzenka.com
        </li>
      </ul>

      <ul className={styles.card__tags}>
        <li className={styles.card__tags__item}>HTML</li>
        <li className={styles.card__tags__item}>CSS</li>
        <li className={styles.card__tags__item}>JS</li>
